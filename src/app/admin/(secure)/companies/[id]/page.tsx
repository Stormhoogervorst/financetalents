          ...
          <div className="flex flex-wrap items-start justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <form action={impersonateEmployerAction}>
                ...
                <button
                  type="submit"
                  title="Open het companys-dashboard precies zoals deze klant het ziet"
              ...
              <Link
                ...
                title="Open the job form with this company preselected"
        ...
        <div className="rounded-2xl bg-white ring-1 ring-gray-200 shadow-sm overflow-hidden">
          <div className="border-b border-gray-100 px-6 py-4">
            ...
            <p className="text-xs text-gray-500">
              All jobs van {firm.name} with the related number of applications.
            </p>
          </div>
