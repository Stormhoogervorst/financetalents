...
/**
 * Companieslijst voor de Super Admin.
 *
 * De dashboard-pagina (/admin) toont ook een companys-tabel, maar die
 ...
 * waar je vanaf doorklikt naar het detailscherm per company.
 *
 ...
 * application-counts). Bij honderden companys is dat nog ruim snel
  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 py-10 space-y-8">
      ...
      <div>
        ...
        <h1 className="mt-3 text-2xl font-bold text-gray-900">Companies</h1>
        <p className="mt-1 text-sm text-gray-500">
          All geregistreerde companys op het platform, nieuwste eerst.
        </p>
      </div>
      ...
      <div className="rounded-2xl bg-white ring-1 ring-gray-200 shadow-sm overflow-hidden">
        <div className="flex items-center justify-between border-b border-gray-100 px-6 py-4">
          <div>
            <h2 className="text-sm font-semibold text-gray-900">
              {firms.length} company{firms.length !== 1 ? "s" : ""}
            </h2>
        ...
        {firms.length === 0 ? (
          <div className="px-6 py-16 text-center text-sm text-gray-400">
            ...
            <p className="mt-2">Nog geen companys geregistreerd.</p>
          </div>
        ) : (
