...
// company-account inclusief jobs, applications en blogs via
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="mt-1 text-sm text-gray-600">
                  ...
                  alle jobs, applications, blogs en uitnodigingen die
                  aan deze company gekoppeld zijn.
                </p>
